...
public:
  ...
  int render(DisplayDriver& display) override {
    ...
    if (_page == HomePage::FIRST) {
      ...
      // DL9SAU 2026-08-10 Merge 1.17.0: #3034 ersetzte enum Color durch die
      // UIColor-Klasse (element-typisierte Farben). Der fruehere YELLOW-Akzent
      // der Stats-Seite -> warning_txt (0xFD20 Amber, farblich am naechsten;
      // auf Mono-OLEDs ohnehin weiss).
      display.setColor(UIColor::warning_txt);
      display.setTextSize(1);
